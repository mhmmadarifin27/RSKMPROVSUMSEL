    ...
    <footer className="w-full bg-emerald-950 text-slate-300 border-t border-emerald-900/60 py-16 relative overflow-visible mt-20">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 relative z-10 pt-10">
        ...
        <div className="space-y-4">
          ...
          {/* Maps Iframe */}
          <div className="w-full h-28 rounded-xl overflow-hidden border border-emerald-900/60 shadow-inner relative group">
            <iframe
            ...
            <a
              ...
              className="absolute inset-0 z-10 bg-black/0 hover:bg-black/10 flex items-center justify-center transition-colors cursor-pointer"
              title="Buka Rute di Google Maps"
            >
              <span className="bg-emerald-600/90 text-white font-extrabold text-[9px] px-2.5 py-1.5 rounded-full uppercase tracking-wider opacity-0 group-hover:opacity-100 transition-opacity shadow-md pointer-events-none">
                Buka di Google Maps
              </span>
            </a>
          </div>
